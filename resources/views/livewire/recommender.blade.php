    ...
    <div x-data="{ showModal: false }">
        <div class="pt-12">
            <section class="bg-white dark:bg-gray-950">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-md sm:text-center">
                        ...
                        <p
                            ...
                            The Course Recommender System is exclusively developed for ISAT U Miagao Campus which aims
                            to
                    ...
                    <form wire:submit.prevent="submitForm" class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl">
                            ...
                            <section class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 p-8">
                                ...
                                <div class="text-start">
                                    ...
                                    <input wire:model="average" type="number" id="average" min="75"
                                        max="100" value="75"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-8">
                                ...
                                <div class="flex items-center mb-2">
                                    <input wire:model="skills" type="checkbox" value="{{ $skill->id }}"
                        ...
                        <button type="submit"
                            class="w-full md:w-1/2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                            Submit
                        </button>
                    </form>
                </div>
                ...
                <!-- Modal -->
                <div x-data="{ showModal: @entangle('showModal') }" x-show="showModal" x-transition
                    class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-gray-800 bg-opacity-50">
                    <div class="relative p-4 w-full max-w-md bg-white rounded-lg shadow-lg dark:bg-gray-700">
                        ...
                        <div class="text-center p-4">
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Courses You Qualify
                                For:</h3>
                            @if(count($qualifiedCourses) > 0)
                            <ul class="list-disc list-inside">
                                <p class="dark:text-white text-lg">Top 3</p>
                                @foreach ($qualifiedCourses as $course)
                                <li class="dark:text-white">{{ $course->name }} ({{ $course->course_code }})</li>
                                @endforeach
                            </ul>
                            @else
                            <p class="dark:text-white mb-5">There is no qualified course for your average.</p>
                            @endif
                            <button wire:click="closeModal"
                                class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5">
                                Close
                            </button>
                        </div>
                    </div>
